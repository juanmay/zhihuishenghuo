<?php /*a:2:{s:72:"C:\phpStudy\PHPTutorial\WWW\dscj\application\agent\view\login\index.html";i:1560561973;s:72:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\public\main.html";i:1559637333;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
    <head>
        <meta charset="utf-8">
    ...
    <div class="container">
        <form autocomplete="off" onsubmit="return false;" data-time="0.001" data-auto="true" method="post" class="content layui-form animated fadeInDown">
            ...
            <ul>
                <li class="allmember">
                    <i></i>
                    <input required pattern="^\S{10,}$" name="allmember" value="1000000001" type="text" autofocus="autofocus" autocomplete="off" title="请输入商户号" placeholder="商户号">
                </li>
                <li class="username">
                    <i></i>
                    <input required pattern="^\S{11,}$" name="phone" value="15985694125" type="text" autofocus="autofocus" autocomplete="off" title="请输入手机号码" placeholder="手机号码">
                </li>
                <li class="password">
                    <i></i>
                    <input required pattern="^\S{4,}$" name="password" value="123456" type="password" autocomplete="off" title="请输入4位及以上的字符" placeholder="请输入密码">
                </li>
