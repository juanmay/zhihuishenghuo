<?php /*a:2:{s:74:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\cash\index.html";i:1560850977;s:78:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <select name="status" class="layui-select">
                ...
                <!--<?php foreach(["0"=>"处理中","1"=>"已成功","2"=>"已失败"] as $k=>$v): ?>-->
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <td class='text-center'>
                <?php if($vo['status'] == 0): ?><span>处理中</span><?php elseif($vo['status'] == 1): ?><span class="color-green">已成功</span><?php elseif($vo['status'] == 2): ?><span class="color-red">已失败</span><?php endif; ?>
            </td>
