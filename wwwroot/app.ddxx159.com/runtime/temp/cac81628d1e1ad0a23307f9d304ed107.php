<?php /*a:1:{s:77:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\allmember\fee.html";i:1560493615;}*/ ?>
<style type="text/css">
    .layui-form-label {
        width: 120px;
    }
...
<form autocomplete="off" class="layui-form layui-box modal-form-box" action="<?php echo request()->url(); ?>" data-auto="true" method="post">
	...
	<div class="layui-form-item">
        <label class="layui-form-label">平台最小提现金额</label>
        <div class="layui-input-block">
            <input type="text" name="cashMinMoney" readonly value='<?php echo htmlentities((isset($vo['cashMinMoney']) && ($vo['cashMinMoney'] !== '')?$vo['cashMinMoney']:"")); ?>' class="layui-input">
            <p class="help-block color-desc">用户使用软件时最小提现金额</p>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">平台最大提现金额</label>
        <div class="layui-input-block">
            <input type="text" name="cashMaxMoney" readonly value='<?php echo htmlentities((isset($vo['cashMaxMoney']) && ($vo['cashMaxMoney'] !== '')?$vo['cashMaxMoney']:"")); ?>' class="layui-input">
            <p class="help-block color-desc">用户使用软件时最大提现金额</p>
        </div>
    </div>
	<div class="layui-form-item">
        <label class="layui-form-label">平台提现单笔手续费</label>
        <div class="layui-input-block">
