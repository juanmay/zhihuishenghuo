<?php /*a:2:{s:71:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\cate\index.html";i:1556437960;s:75:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<form autocomplete="off" class="layui-form layui-form-pane form-search" action="<?php echo request()->url(); ?>" onsubmit="return false" method="get">
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <input name="cateName" value="<?php echo htmlentities(app('request')->get('cateName')); ?>" placeholder="请输入分类名称" class="layui-input">
        </div>
    </div>
...
<form autocomplete="off" onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <th class="text-center nowrap">分类名称</th>
        ...
        <tr>
            ...
            <td class="text-center nowrap"><?php echo htmlentities($vo['cateName']); ?></td>
