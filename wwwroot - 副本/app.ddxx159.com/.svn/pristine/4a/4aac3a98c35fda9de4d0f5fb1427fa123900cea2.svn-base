<?php /*a:2:{s:77:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\allcash\index.html";i:1560934072;s:78:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <td class='text-center notselect'>
                <?php if($vo['status'] == 0 and auth("$classuri/succ")): ?>
                <span class="text-explode">|</span>
                <a data-update="<?php echo htmlentities($vo['id']); ?>" data-field='status' data-value='1' data-action='<?php echo url("$classuri/succ"); ?>'>放款</a>
                <?php endif; if($vo['status'] == 0 and  auth("$classuri/fail")): ?>
                <span class="text-explode">|</span>
                <a data-update="<?php echo htmlentities($vo['id']); ?>" data-field='status' data-value='2' data-action='<?php echo url("$classuri/fail"); ?>'>驳回</a>
                <?php endif; ?>
            </td>
        </tr>
        <?php endforeach; ?>
