<?php /*a:2:{s:87:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\repaymentmember\running.html";i:1565764118;s:78:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <select name="channel_type" class="layui-select">
                ...
                <!--<?php foreach(repaymentChannelType() as $k=>$v): ?>-->
...
<form onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <th class='text-center'>手机/姓名(中介)</th>
        ...
        <tr>
            ...
            <td class='text-center'><?php echo htmlentities($vo['z_phone']); ?>/<?php echo htmlentities($vo['z_realname']); ?></td>
            ...
            <td class='text-center'><?php echo htmlentities(date('Y-m-d',!is_numeric($vo['start_time'])? strtotime($vo['start_time']) : $vo['start_time'])); ?>至<?php echo htmlentities(date('Y-m-d',!is_numeric($vo['end_time'])? strtotime($vo['end_time']) : $vo['end_time'])); ?></td>
            ...
            <td class='text-center'>
             ...
             <td class='text-center'>
                ...
                <a data-title="查看" data-open="<?php echo url("$classuri/info"); ?>?id=<?php echo htmlentities($vo['id']); ?>&allmemberId=<?php echo htmlentities($allmemberId); ?>">查看</a>
                <?php endif; ?>
             </td>
        </tr>
        <!--<?php endforeach; ?>-->
