<?php /*a:1:{s:71:"C:\phpStudy\PHPTutorial\WWW\dscj\application\member\view\menu\form.html";i:1548308490;}*/ ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <p class="help-block color-desc">
                <b>必填</b>，请填写系统节点（如：agent/user/index），节点加入权限管理时菜单才会自动隐藏，非规则内的不会隐藏；
