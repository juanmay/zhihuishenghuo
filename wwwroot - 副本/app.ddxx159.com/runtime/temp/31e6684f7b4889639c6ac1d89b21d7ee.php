<?php /*a:2:{s:75:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\question\index.html";i:1556184467;s:75:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<button data-modal='<?php echo url("$classuri/add"); ?>' data-title="添加问答" class='layui-btn layui-btn-sm layui-btn-primary'>添加问答</button>
<!--<?php endif; ?>-->
<!--<?php if(auth("$classuri/del")): ?>-->
<button data-update data-field='delete' data-action='<?php echo url("$classuri/del"); ?>' class='layui-btn layui-btn-sm layui-btn-primary'>删除问答</button>
<!--<?php endif; ?>-->
</div>
    </div>
    <!--<?php endif; ?>-->
...
<form autocomplete="off" class="layui-form layui-form-pane form-search" action="<?php echo request()->url(); ?>" onsubmit="return false" method="get">
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <input name="title" value="<?php echo htmlentities(app('request')->get('title')); ?>" placeholder="请输入问答标题" class="layui-input">
        </div>
    </div>
...
<form autocomplete="off" onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <th class="text-center nowrap">问题</th>
