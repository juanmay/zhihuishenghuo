<?php /*a:2:{s:81:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\achievement\index.html";i:1560849967;s:78:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<form autocomplete="off" class="layui-form layui-form-pane form-search" action="<?php echo request()->url(); ?>" onsubmit="return false" method="get">
    ...
    <?php if (input('id')>0): ?>
    <div class="layui-form-item layui-inline">
        <button class="layui-btn layui-btn-primary" onclick="javascript:location.href='<?php echo URL("/admin.html#/admin/achievement/index"); ?>?allmemberId=<?php echo htmlentities($allmemberId); ?>&spm=<?php echo input('spm'); ?>';"><i class="layui-icon">&#xe603;</i> 返 回</button>
    </div>
    <?php endif ?>
<script>
    window.form.render();
...
<form autocomplete="off" onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <th class="text-center nowrap">业绩金额</th>
        ...
        <tr>
            ...
            <td class="text-center nowrap">￥<?php echo htmlentities(sprintf("%.2f",$vo['reward'])); ?></td>
            <td class='text-center notselect'>
                <a href='<?php echo URL("/admin.html#/admin/achievement/index"); ?>?spm=<?php echo input('spm'); ?>&id=<?php echo htmlentities($vo['id']); ?>&allmemberId=<?php echo htmlentities($allmemberId); ?>'>查看名下用户</a>
            </td>
        </tr>
        <?php endforeach; ?>
        </tbody>
