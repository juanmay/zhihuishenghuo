<?php /*a:2:{s:76:"D:\wwwroot\app.ddxx159.com\application\admin\view\repaymentcard\running.html";i:1569753522;s:69:"D:\wwwroot\app.ddxx159.com\application\admin\view\public\content.html";i:1569753523;}*/ ?>
<!-- 右则内容区域 开始 -->
    ...
    <!-- <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <select name="channel_type" class="layui-select">
                ...
                <?php foreach(["cj"=>"畅捷大额","hx"=>"环讯小额"] as $k=>$v): if(app('request')->get('channel_type') == "$k"): ?>
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <td class='text-center'>
                <!--<?php foreach(["cjm"=>"畅捷小额","hx"=>"环讯小额"] as $k=>$v): ?>-->
