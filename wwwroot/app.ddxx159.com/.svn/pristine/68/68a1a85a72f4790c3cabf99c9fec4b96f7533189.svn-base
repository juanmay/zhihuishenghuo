<?php /*a:2:{s:73:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\member\index.html";i:1560405676;s:75:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <td class='text-center notselect'>
                ...
                <?php endif; if(auth("$classuri/recommend")): ?>
                <span class="text-explode">|</span>
                <a data-title="变更上级" data-modal='<?php echo url("$classuri/recommend"); ?>?id=<?php echo htmlentities($vo['id']); ?>'>变更上级</a>
                <?php endif; if(auth("$classuri/downrecommend")): ?>
                <span class="text-explode">|</span>
                <a data-title="查看下级" data-modal='<?php echo url("$classuri/downrecommend"); ?>?id=<?php echo htmlentities($vo['id']); ?>'>查看下级</a>
