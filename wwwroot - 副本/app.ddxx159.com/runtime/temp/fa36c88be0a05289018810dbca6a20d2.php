<?php /*a:2:{s:72:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\group\money.html";i:1556612088;s:75:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <td class='text-center notselect'>
                <a href='<?php echo URL("/admin.html#/admin/group/money"); ?>?spm=<?php echo input('spm'); ?>&id=<?php echo htmlentities($vo['id']); ?>'>查看名下用户</a>
            </td>
        </tr>
        <?php endforeach; ?>
        </tbody>
