<?php /*a:2:{s:54:"E:\www\jinma\application\admin\view\channel\index.html";i:1556438003;s:55:"E:\www\jinma\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<form autocomplete="off" onsubmit="return false;" action="<?php echo request()->url(); ?>" data-auto="true" method="post" class='form-horizontal layui-form padding-top-20'> 
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">
            fifthRepaymentStatus<br><span class="nowrap color-desc">酷宝小额状态</span>
        </label>
        <div class='col-sm-8'>
            <?php foreach(['1'=>'开启','0'=>'关闭'] as $k=>$v): ?>
            <label class="think-radio">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">
            fifthRepaymentName<br><span class="nowrap color-desc">酷宝小额名称</span>
        </label>
        <div class='col-sm-8'>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">
            fifthRepaymentInfo<br><span class="nowrap color-desc">酷宝小额描述</span>
        </label>
        <div class='col-sm-8'>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">
            sixthRepaymentStatus<br><span class="nowrap color-desc">酷宝大额555状态</span>
        </label>
        <div class='col-sm-8'>
            <?php foreach(['1'=>'开启','0'=>'关闭'] as $k=>$v): ?>
            <label class="think-radio">
                <!--<?php if(sysconf('sixthRepaymentStatus') == $k): ?>-->
                <input checked type="radio" name="sixthRepaymentStatus" value="<?php echo htmlentities($k); ?>" title="<?php echo htmlentities($v); ?>" lay-ignore>
                <!--<?php else: ?>-->
                <input type="radio" name="sixthRepaymentStatus" value="<?php echo htmlentities($k); ?>" title="<?php echo htmlentities($v); ?>" lay-ignore>
                <!--<?php endif; ?>-->
                <?php echo htmlentities($v); ?>
            </label>
            <?php endforeach; ?>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">
            sixthRepaymentName<br><span class="nowrap color-desc">酷宝通道名称</span>
        </label>
        <div class='col-sm-8'>
            <input name="sixthRepaymentName" required="required" title="请输入通道名称" placeholder="请输入通道名称" value="<?php echo sysconf('sixthRepaymentName'); ?>" class="layui-input">
            <p class="help-block">当前系统通道名称，用于APP展示。</p>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">
            sixthRepaymentInfo<br><span class="nowrap color-desc">酷宝通道描述</span>
        </label>
        <div class='col-sm-8'>
            <input name="sixthRepaymentInfo" required="required" title="请输入通道描述" placeholder="请输入通道描述" value="<?php echo sysconf('sixthRepaymentInfo'); ?>" class="layui-input">
            <p class="help-block">当前系统通道描述，用于APP展示。</p>
        </div>
    </div>
    <hr/>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">
            seventhRepaymentStatus<br><span class="nowrap color-desc">酷宝通道状态</span>
        </label>
        <div class='col-sm-8'>
            <?php foreach(['1'=>'开启','0'=>'关闭'] as $k=>$v): ?>
            <label class="think-radio">
                <!--<?php if(sysconf('seventhRepaymentStatus') == $k): ?>-->
                <input checked type="radio" name="seventhRepaymentStatus" value="<?php echo htmlentities($k); ?>" title="<?php echo htmlentities($v); ?>" lay-ignore>
                <!--<?php else: ?>-->
                <input type="radio" name="seventhRepaymentStatus" value="<?php echo htmlentities($k); ?>" title="<?php echo htmlentities($v); ?>" lay-ignore>
                <!--<?php endif; ?>-->
                <?php echo htmlentities($v); ?>
            </label>
            <?php endforeach; ?>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">
            seventhRepaymentName<br><span class="nowrap color-desc">酷宝通道名称</span>
        </label>
        <div class='col-sm-8'>
            <input name="seventhRepaymentName" required="required" title="请输入通道名称" placeholder="请输入通道名称" value="<?php echo sysconf('seventhRepaymentName'); ?>" class="layui-input">
            <p class="help-block">当前系统通道名称，用于APP展示。</p>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">
            seventhRepaymentInfo<br><span class="nowrap color-desc">酷宝通道描述</span>
        </label>
        <div class='col-sm-8'>
            <input name="seventhRepaymentInfo" required="required" title="请输入通道描述" placeholder="请输入通道描述" value="<?php echo sysconf('seventhRepaymentInfo'); ?>" class="layui-input">
            <p class="help-block">当前系统通道描述，用于APP展示。</p>
        </div>
    </div>
    <hr/>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">
            eighthRepaymentStatus<br><span class="nowrap color-desc">酷宝通道状态</span>
        </label>
        <div class='col-sm-8'>
            <?php foreach(['1'=>'开启','0'=>'关闭'] as $k=>$v): ?>
            <label class="think-radio">
                <!--<?php if(sysconf('eighthRepaymentStatus') == $k): ?>-->
                <input checked type="radio" name="eighthRepaymentStatus" value="<?php echo htmlentities($k); ?>" title="<?php echo htmlentities($v); ?>" lay-ignore>
                <!--<?php else: ?>-->
                <input type="radio" name="eighthRepaymentStatus" value="<?php echo htmlentities($k); ?>" title="<?php echo htmlentities($v); ?>" lay-ignore>
                <!--<?php endif; ?>-->
                <?php echo htmlentities($v); ?>
            </label>
            <?php endforeach; ?>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">
            eighthRepaymentName<br><span class="nowrap color-desc">酷宝通道名称</span>
        </label>
        <div class='col-sm-8'>
            <input name="eighthRepaymentName" required="required" title="请输入通道名称" placeholder="请输入通道名称" value="<?php echo sysconf('eighthRepaymentName'); ?>" class="layui-input">
            <p class="help-block">当前系统通道名称，用于APP展示。</p>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">
            eighthRepaymentInfo<br><span class="nowrap color-desc">酷宝通道描述</span>
        </label>
        <div class='col-sm-8'>
            <input name="eighthRepaymentInfo" required="required" title="请输入通道描述" placeholder="请输入通道描述" value="<?php echo sysconf('eighthRepaymentInfo'); ?>" class="layui-input">
            <p class="help-block">当前系统通道描述，用于APP展示。</p>
        </div>
    </div>
    <hr/>
