<?php /*a:2:{s:58:"E:\www\jinma\application\admin\view\repayment\running.html";i:1556184468;s:55:"E:\www\jinma\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <select name="channel_type" class="layui-select">
                ...
                <!--<?php foreach(["cj"=>"畅捷大额","tl"=>"通联小额","kb"=>"酷宝大额","kbm"=>"酷宝小额"] as $k=>$v): ?>-->
