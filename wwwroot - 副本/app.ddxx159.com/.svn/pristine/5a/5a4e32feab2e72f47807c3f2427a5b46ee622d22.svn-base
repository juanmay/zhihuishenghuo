 ...
 */
class Repaymentcard extends BasicAdmin
{
    ...
    public function info(){
        ...
        ->join('member b','a.memberId=b.id','left')
        ->join('credit_card c','a.cardId=c.id','left')
        ->join('credit_card d','a.oneCardId=d.id','left')
        ->field('a.*,b.realname,b.phone,b.idcard,c.bank_num,c.bank_name,d.bank_num as one_bank_num,d.bank_name as one_bank_name')
