<?php /*a:2:{s:79:"C:\phpStudy\PHPTutorial\WWW\dscj\application\member\view\achievement\index.html";i:1560585975;s:75:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <td class='text-center notselect'>
                <a data-open='<?php echo URL("/member/achievement/index"); ?>?spm=<?php echo input('spm'); ?>&id=<?php echo htmlentities($vo['id']); ?>'>查看名下用户</a>
            </td>
        </tr>
        <?php endforeach; ?>
        </tbody>
