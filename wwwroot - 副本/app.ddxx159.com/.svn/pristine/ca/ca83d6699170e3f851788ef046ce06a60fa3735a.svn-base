<?php /*a:2:{s:73:"C:\phpStudy\PHPTutorial\WWW\dscj\application\member\view\index\index.html";i:1560566256;s:72:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\public\main.html";i:1559637333;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
    <head>
        <meta charset="utf-8">
...
<div class="framework-topbar">
    <div class="topbar-head pull-left">
        <a href="<?php echo url('@'); ?>" class="topbar-logo pull-left"><?php echo sysconf('app_name'); ?> （用户）<sup><?php echo sysconf('app_version'); ?></sup></a>
    </div>
    ...
    <div class="pull-right">
        ...
        <div class="dropdown">
            <a href="#" class="dropdown-toggle topbar-btn text-center transition" data-toggle="dropdown">
                ...
                <?php echo session('user.phone'); ?>
                <span class="toggle-icon glyphicon glyphicon-menu-up transition font-s13"></span>
            </a>
            <ul class="dropdown-menu">
                <li class="topbar-btn"><a data-modal="<?php echo url('member/index/pass'); ?>?id=<?php echo session('user.id'); ?>" data-title="修改密码"><i class="glyphicon glyphicon-lock"></i> 修改密码</a></li>
                <li class="topbar-btn"><a data-modal="<?php echo url('member/index/info'); ?>?id=<?php echo session('user.id'); ?>" data-title="修改资料"><i class="glyphicon glyphicon-edit"></i> 修改资料</a></li>
                <li class="topbar-btn">
                    <a data-load="<?php echo url('member/login/out'); ?>" data-confirm="确定要退出登录吗？"><i class="glyphicon glyphicon-log-out"></i> 退出登录</a>
                </li>
            </ul>
        </div>
        <!--<?php else: ?>-->
        <div class="topbar-info-item">
            <a data-href="<?php echo url('@member/login'); ?>" data-toggle="dropdown" class=" topbar-btn text-center">
