<?php /*a:2:{s:71:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\open\index.html";i:1556184468;s:75:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<button data-modal='<?php echo url("$classuri/add"); ?>' data-title="添加启动页" class='layui-btn layui-btn-sm layui-btn-primary'>添加启动页</button>
<!--<?php endif; ?>-->
<!--<?php if(auth("$classuri/del")): ?>-->
<button data-update data-field='delete' data-action='<?php echo url("$classuri/del"); ?>' class='layui-btn layui-btn-sm layui-btn-primary'>删除启动页</button>
<!--<?php endif; ?>-->
</div>
    </div>
    <!--<?php endif; ?>-->
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <td class="text-center nowrap">
                <img data-tips-image style="height:auto;max-height:32px;min-width:32px" src="<?php echo htmlentities((isset($vo['ios1']) && ($vo['ios1'] !== '')?$vo['ios1']:'/static/goods.png')); ?>"/>
            </td>
            ...
            <td class="text-center nowrap"><?php echo htmlentities($vo['sort']); ?></td>
