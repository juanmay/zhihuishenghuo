<?php /*a:2:{s:73:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\banner\index.html";i:1556184467;s:75:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<button data-modal='<?php echo url("$classuri/add"); ?>' data-title="添加Banner" class='layui-btn layui-btn-sm layui-btn-primary'>添加Banner</button>
<!--<?php endif; ?>-->
<!--<?php if(auth("$classuri/del")): ?>-->
<button data-update data-field='delete' data-action='<?php echo url("$classuri/del"); ?>' class='layui-btn layui-btn-sm layui-btn-primary'>删除Banner</button>
<!--<?php endif; ?>-->
</div>
    </div>
    <!--<?php endif; ?>-->
