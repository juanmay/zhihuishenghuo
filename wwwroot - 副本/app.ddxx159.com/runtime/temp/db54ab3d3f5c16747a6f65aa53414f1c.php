<?php /*a:2:{s:72:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\quick\index.html";i:1556184467;s:75:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <select name="type" class="layui-select">
                ...
                <!--<?php foreach(["xf"=>"先锋","cj"=>"畅捷"] as $k=>$v): ?>-->
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <td class='text-center notselect'>
                ...
                <a data-title="查看" data-modal='<?php echo url("$classuri/info"); ?>?id=<?php echo htmlentities($vo['id']); ?>'>查看</a>
                <?php endif; if ($vo['status'] == "5"): if(auth("$classuri/repay")): ?>
                <span class="text-explode">|</span>
                <a data-title="重提" data-modal='<?php echo url("$classuri/repay"); ?>?id=<?php echo htmlentities($vo['id']); ?>'>重提</a>
                <?php endif; endif ?>
