<?php /*a:2:{s:78:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\levellog\index.html";i:1560850289;s:78:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<form autocomplete="off" onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <tr>
            ...
            <th class="text-center nowrap">调整等级</th>
            <th class="text-center nowrap">调整说明</th>
            <th class="text-center nowrap">调整时间</th>
        </tr>
        </thead>
        <tbody>
        ...
        <tr>
            ...
            <td class="text-center nowrap"><?php echo htmlentities($vo['level']); ?></td>
