<?php /*a:2:{s:78:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\moneylog\index.html";i:1560850829;s:78:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <select name="moneyType" class="layui-select">
                ...
                <!--<?php foreach(["1"=>"收益分配","2"=>"提现申请","3"=>"提现成功","4"=>"提现失败","5"=>"升级使用","6"=>"系统调整"] as $k=>$v): ?>-->
