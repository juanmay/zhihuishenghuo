<?php /*a:2:{s:84:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\repaymentmember\info.html";i:1560413824;s:78:"C:\phpStudy\PHPTutorial\WWW\dscjall\application\admin\view\public\content.html";i:1556184467;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<table class="layui-table">
	<tbody>
		<tr>
			<td align="right" width="150">中介手机</td><td><?php echo htmlentities($info['z_phone']); ?></td>
			<td align="right" width="150">中介姓名</td><td><?php echo htmlentities($info['z_realname']); ?></td>
		</tr>
		<tr>
		...
		<tr>
            <td align="right" width="150">运行通道</td><td><?php foreach(["cj"=>"畅捷大额","tl"=>"通联小额","kb"=>"酷宝大额","kbm"=>"酷宝小额"] as $k=>$v): if($info['channel_type'] == "$k"): ?><?php echo htmlentities($v); endif; endforeach; ?></td>
