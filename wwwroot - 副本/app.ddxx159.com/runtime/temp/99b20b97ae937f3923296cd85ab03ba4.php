<?php /*a:2:{s:72:"D:\wwwroot\app.ddxx159.com\application\admin\view\allmoneylog\index.html";i:1569753522;s:69:"D:\wwwroot\app.ddxx159.com\application\admin\view\public\content.html";i:1569753523;}*/ ?>
<!-- 右则内容区域 开始 -->
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <select name="moneyType" class="layui-select">
                ...
                <!--<?php foreach(["1"=>"收益分配","2"=>"提现申请","3"=>"提现成功","4"=>"提现失败","5"=>"全额扣款","6"=>"全额入账","7"=>"平台充值","8"=>"平台扣款"] as $k=>$v): ?>-->
