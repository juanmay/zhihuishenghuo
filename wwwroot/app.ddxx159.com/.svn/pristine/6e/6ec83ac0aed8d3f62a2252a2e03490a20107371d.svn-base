 ...
 */
class Repaymentmember extends BasicAdmin
{
    ...
    public function running()
    {
        ...
        ->join('credit_card_member c','a.cardId=c.id','left')
        ->field('a.*,b.realname as z_realname,b.phone as z_phone,c.realname,c.phone,c.bank_num,c.bank_name')->order('a.id DESC');
    ...
    public function info(){
        ...
        ->join('member b','a.memberId=b.id','left')
        ->join('credit_card_member c','a.cardId=c.id','left')
        ->field('a.*,b.realname as z_realname,b.phone as z_phone,c.realname,c.phone,c.idcard,c.bank_num,c.bank_name')
