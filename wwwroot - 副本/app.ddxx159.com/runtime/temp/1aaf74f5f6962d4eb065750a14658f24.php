<?php /*a:2:{s:72:"C:\phpStudy\PHPTutorial\WWW\dscj\application\agent\view\index\index.html";i:1548308490;s:72:"C:\phpStudy\PHPTutorial\WWW\dscj\application\admin\view\public\main.html";i:1559637333;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
    <head>
        <meta charset="utf-8">
...
<div class="framework-topbar">
    <div class="topbar-head pull-left">
        <a href="<?php echo url('@'); ?>" class="topbar-logo pull-left"><?php echo sysconf('app_name'); ?> （代理）<sup><?php echo sysconf('app_version'); ?></sup></a>
    </div>
    ...
    <div class="pull-right">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li class="topbar-btn"><a data-modal="<?php echo url('agent/index/pass'); ?>?id=<?php echo session('user.id'); ?>" data-title="修改密码"><i class="glyphicon glyphicon-lock"></i> 修改密码</a></li>
                <li class="topbar-btn"><a data-modal="<?php echo url('agent/index/info'); ?>?id=<?php echo session('user.id'); ?>" data-title="修改资料"><i class="glyphicon glyphicon-edit"></i> 修改资料</a></li>
                <li class="topbar-btn">
                    <a data-load="<?php echo url('agent/login/out'); ?>" data-confirm="确定要退出登录吗？"><i class="glyphicon glyphicon-log-out"></i> 退出登录</a>
                </li>
            </ul>
        </div>
        <!--<?php else: ?>-->
        <div class="topbar-info-item">
            <a data-href="<?php echo url('@agent/login'); ?>" data-toggle="dropdown" class=" topbar-btn text-center">
