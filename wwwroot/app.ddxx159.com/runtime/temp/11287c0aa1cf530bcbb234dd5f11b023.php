<?php /*a:2:{s:73:"D:\wwwroot\app.ddxx159.com\application\admin\view\repaymentcard\info.html";i:1569753522;s:69:"D:\wwwroot\app.ddxx159.com\application\admin\view\public\content.html";i:1569753523;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<table class="layui-table">
	<tbody>
		...
		<tr>
            <td align="right" width="150">运行通道</td><td><?php foreach(["cjm"=>"畅捷小额","hx"=>"环讯小额"] as $k=>$v): if($info['channel_type'] == "$k"): ?><?php echo htmlentities($v); endif; endforeach; ?></td>
		...
		<tr>
            <td align="right" width="150">代付银行名称</td><td><?php echo htmlentities($info['one_bank_name']); ?></td>
			<td align="right" width="150">代付银行卡号</td><td><?php echo htmlentities($info['one_bank_num']); ?></td>
		</tr>
